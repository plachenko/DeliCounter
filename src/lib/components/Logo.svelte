<div class="flex-1 flex justify-center items-center pl-4 select-none">
	<div
		class="w-[165px] h-[85px] bg-white rounded-2xl scale-[1.5] pl-7 items-center justify-center flex border-red-600 absolute border-4"
	>
		<div
		...
		>
			<span class="absolute w-full text-center tracking-[-1px] pb-[2px] [word-spacing: -20px]">
